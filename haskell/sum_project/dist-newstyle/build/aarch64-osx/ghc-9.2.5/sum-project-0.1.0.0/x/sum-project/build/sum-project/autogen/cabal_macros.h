...
/* package sum-project-0.1.0.0 */
#ifndef VERSION_sum_project
#define VERSION_sum_project "0.1.0.0"
#endif /* VERSION_sum_project */
#ifndef MIN_VERSION_sum_project
#define MIN_VERSION_sum_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sum_project */
...
#define CURRENT_COMPONENT_ID "sum-project-0.1.0.0-inplace-sum-project"
